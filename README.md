...
- LLM Agents and tool-using AI
- MCP-based applications
- Geospatial and mapping systems
- Routing and optimization systems
...
I enjoy working across the full path from **problem → architecture → implementation → deployment**.

My focus is not only on individual models or frameworks, but on building systems where:

**AI + Backend + Data + Infrastructure + Algorithms**
